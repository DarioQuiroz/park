...
$objPHPExcel->getProperties()->setCreator("Dario Quiroz")
							 ->setLastModifiedBy("Dario Quiroz")
...
/*Extraer datos de MYSQL*/
	...
	while ($row=mysqli_fetch_array($query)){
		$countryCode=$row['id'];
		$countryName=$row['folder'];
		$currencyCode=$row['src'];
		$capital=$row['created_at'];
		$continentName=$row['estado'];
...
header('Content-Disposition: attachment;filename="reporte_de_facturacion.xls"');

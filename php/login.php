...
<body>
            ...
            <nav class="navbar navbar-default">
              <div class="container-fluid">
                ...
                <div class="navbar-header">
                  <button id="menu-boton" type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#bs-example-navbar-collapse-1" aria-expanded="false">
  ...
  <section class="container">
    <div class="row ">
      <div class="col-4"></div>
      <form style="text-align:center;" action="validarcorreo.php" method="post" class="form-signin col-4">

        <h1 class="h3 mb-3 font-weight-normal">Ingresar</h1>
        <p>Una vez registrado, ingresa tus datos<br> para publicar una vacante.</p>

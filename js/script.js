...
$(document).ready(function () {
 ...
 $(document).ready(function () {
     ...
     $(".popup15 > span, .popup15").click(function () {
         $(".popup15").fadeOut(300);
     });
 });
 ...
 // funcion del pop inicial
 $(function() {
    $('.pop_inicial').hide();
    $('.pop_inicial').fadeIn(1000);
    
        $('.close-button').click(function (e) { 
  
        $('.pop_inicial').fadeOut(700);
        $('#overlayini').removeClass('blur-in');
        $('#overlayini').addClass('blur-out');
        e.stopPropagation();
